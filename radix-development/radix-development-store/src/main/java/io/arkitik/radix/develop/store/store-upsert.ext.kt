...
infix fun <ID : Serializable, I : Identity<ID>> Store<ID, I>.insertIgnore(identities: List<I>) = identities.insertIgnore()

infix fun <ID : Serializable, I : Identity<ID>> Store<ID, I>.updateIgnore(identity: I) = identity.updateIgnore()

infix fun <ID : Serializable, I : Identity<ID>> Store<ID, I>.updateIgnore(identities: List<I>) = identities.updateIgnore()
